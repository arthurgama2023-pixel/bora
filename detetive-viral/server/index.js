...
app.post('/api/instagram/profile', async (req, res) => {
  try {
    ...
    // Frequência de postagem (módulo dedicado: usa a MEDIANA do intervalo entre
    // posts consecutivos — robusta a posts antigos/fixados na amostra).
    const postingFrequency = computePostingFrequency(profile.latestPosts);
