          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                    ...
                    builder: (context) => InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (selectedMedia != null &&
                          ...
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataIu3 = true);
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataIu3 = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedMedia.length &&
                              downloadUrls.length == selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataIu3 =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataIu3 =
                                  downloadUrls.first;
                            });
                ...
                if (valueOrDefault(currentUserDocument?.cpf, '') != null &&
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      if (_model.uploadedFileUrl_uploadDataIu3 != null &&
                          _model.uploadedFileUrl_uploadDataIu3 != '') {
                        if (_model.placePickerValue != null) {
                          await currentUserReference!
                              .update(createUserRecordData(
                            photoUrl: _model.uploadedFileUrl_uploadDataIu3,
