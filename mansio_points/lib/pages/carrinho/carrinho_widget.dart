  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarrinhoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final carrinhoCarrinhoRecord = carrinhoCarrinhoRecordList.isNotEmpty
            ? carrinhoCarrinhoRecordList.first
            : null;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final produtos = carrinhoCarrinhoRecord?.itens
                                  ?.map((e) => e)
                                  .toList()
                                  ?.toList() ??
                              [];
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, produtosIndex) {
                              ...
                              return StreamBuilder<ProdutosRecord>(
                                stream:
                                    ProdutosRecord.getDocument(produtosItem),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          formatNumber(
                                            carrinhoCarrinhoRecord?.subtotal,
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  var comprasRecordReference =
                                      ComprasRecord.collection.doc();
                                  await comprasRecordReference.set({
                                    ...createComprasRecordData(
                                      usuario: currentUserReference,
                                      status: 'Aguardando pagamento',
                                      statusParceiro: 'Aguardando pagamento',
                                      total: carrinhoCarrinhoRecord?.total,
                                    ),
                                    ...mapToFirestore(
                                      {
                                        'produtos':
                                            carrinhoCarrinhoRecord?.itens,
                                      },
                                    ),
                                  });
                                  _model.saidaCompras =
                                      ComprasRecord.getDocumentFromData({
                                    ...createComprasRecordData(
                                      usuario: currentUserReference,
                                      status: 'Aguardando pagamento',
                                      statusParceiro: 'Aguardando pagamento',
                                  ...
                                  }, comprasRecordReference);
                                  FFAppState().valor = functions
                                      .removerNumeros(carrinhoCarrinhoRecord
                                          ?.total
                                          ?.toString())!
                                      .toDouble();
                                  safeSetState(() {});
                                  _model.apiResultvs1 =
                                      await CriarTranferenciaCall.call(
                                  ...
                                  if ((_model.apiResultvs1?.succeeded ??
                                      true)) {
                                    await _model.saidaCompras!.reference
                                        .update(createComprasRecordData(
                                      idPagamento:
                                          CriarTranferenciaCall.idOrdem(
                                        (_model.apiResultvs1?.jsonBody ?? ''),
                                      ),
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child: PagamentoPixMarkWidget(
                                              pagamendDoc: _model
                                                  .saidaCompras!.reference,
                                            ),
                                          ),
                                        );
                                      },
