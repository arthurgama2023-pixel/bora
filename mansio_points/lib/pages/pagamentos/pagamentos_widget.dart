        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'Lista com seu historico de pagamentos.',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.roboto(
                                fontWeight: FontWeight.normal,
                                fontStyle: FlutterFlowTheme.of(context)
              ...
              Expanded(
                child: StreamBuilder<List<AlugueisRecord>>(
                  stream: queryAlugueisRecord(
                    queryBuilder: (alugueisRecord) => alugueisRecord
                        .where(
                          'dono',
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<AlugueisRecord> listViewAlugueisRecordList =
                        snapshot.data!;
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewAlugueisRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewAlugueisRecord =
                            listViewAlugueisRecordList[listViewIndex];
                        return Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                ComprovanteConfereWidget.routeName,
                                queryParameters: {
                                  'pagamentoRef': serializeParam(
                                    listViewAlugueisRecord.reference,
