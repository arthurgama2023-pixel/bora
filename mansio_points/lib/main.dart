...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = mansioPointsFirebaseUserStream()
      ..listen((user) {
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'marketiplace': MarketiplaceWidget(),
      'historicoDePontos': HistoricoDePontosWidget(),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Visibility(
        ...
        child: FloatingNavbar(
          ...
          borderRadius: 32.0,
          itemBorderRadius: 32.0,
          margin: EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 5.0),
